/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 95d2dae928b5873a243f144a9f52a268)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		USER_PROXY: DurableObjectNamespace<import("./src/index").UserProxy>;
		SERVICE_PROXY: DurableObjectNamespace<import("./src/index").ServiceProxy>;
		RESOURCE_PROXY: DurableObjectNamespace<import("./src/index").ResourceProxy>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURN_TOKEN_ID">> {}
}
